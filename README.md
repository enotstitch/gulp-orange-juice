...
│   ├── resources                 # Папка для хранения иных ассетcов - php, видео-файлы, favicon и т.д.
...
│   │   ├── libs                  # Папка для хранения локальных библиотек css-стилей
...
- `npm run git` - копированием файлов из папки build в ветку gh-pages и автоматическое создание ссылки на GitHub Pages в подключённом репозитории
